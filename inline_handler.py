...
def inline_query(update, context):
    ...
    user_name = update.inline_query.from_user.first_name or "Reader"
    results = []
    ...
    if q_lower in ["hub", "myhub", "me", "shelves", "shelf", "list", "fav", "read", "bookmarks"]:
        ...
        results.append(
            InlineQueryResultArticle(
                ...
                thumb_url="https://img.icons8.com/color/96/like--v1.png",
                input_message_content=InputTextMessageContent(
        ...
        results.append(
            InlineQueryResultArticle(
                ...
                thumb_url="https://img.icons8.com/color/96/finish-flag.png",
                input_message_content=InputTextMessageContent(
        ...
        results.append(
            InlineQueryResultArticle(
                ...
                thumb_url="https://img.icons8.com/color/96/pause-button.png",
                input_message_content=InputTextMessageContent(
        ...
        results.append(
            InlineQueryResultArticle(
                ...
                thumb_url="https://img.icons8.com/color/96/trash--v1.png",
                input_message_content=InputTextMessageContent(
        ...
        results.append(
            InlineQueryResultArticle(
                ...
                thumb_url="https://img.icons8.com/color/96/bookmark-ribbon.png",
                input_message_content=InputTextMessageContent(
                    bm_text,
                    parse_mode="HTML",
                    disable_web_page_preview=True
    ...
    for manga in search_results:
        ...
        cover_image = manga.get("image") or f"{WEB_APP_URL}/api/image/{channel_id}"
